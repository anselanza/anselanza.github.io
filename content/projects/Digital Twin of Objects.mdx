...
We had a fairly generic "oloid" shaped dummy object to experiment with. I embedded an ESP32 microcontroller and an [Adafruit 9-DOF sensor](https://www.adafruit.com/product/2472) and powered it with a small Li-ion battery. Data was sent over WiFi using the Tether system I had helped to develop in-house.
